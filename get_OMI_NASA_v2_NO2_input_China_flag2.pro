...
pro get_OMI_NASA_v2_NO2_input_China_flag2
...
dir_output = '/home/liufei/Data/High_resolution/preparation/NASA_v2_OMI_NO2_asc_for_China_cf50/flag2/'+Yr4+'/'+Mon2+'/'
...
ind_ok = where((sdate_s GT 0) AND (no2trp_s GE -10.0) AND                   $
               ...
               ((xtrack_flag_s EQ 0) or (xtrack_flag_s EQ 4)) AND          $
