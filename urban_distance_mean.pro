pro urban_distance_mean
;this program is used to calculate the mean column for city as a function of the distance between the city and the pixel centre
...
num=130
Locate=dblarr(3,num)
filename = '/home/liufei/Data/High_resolution/City_list.csv'
DELIMITER = ','
HEADERLINES = 1
...
outfile ='/home/liufei/Data/High_resolution/City_max_loc.csv'
...
outfile ='/home/liufei/Data/High_resolution/City_distance_no2_'+Yr4+'.csv'
