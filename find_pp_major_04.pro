...
filename ='/home/liufei/Data/Parameters/MEIC_Emission/0.4/'+Yr4+'/'+Yr4+'__residential__NOx.nc'
fid=NCDF_OPEN(filename)
varid1=NCDF_VARID(fid,'z')
NCDF_VARGET, fid, varid1, density1
NCDF_CLOSE, fid

filename ='/home/liufei/Data/Parameters/MEIC_Emission/0.4/'+Yr4+'/'+Yr4+'__industry__NOx.nc'
fid=NCDF_OPEN(filename)
varid2=NCDF_VARID(fid,'z')
NCDF_VARGET, fid, varid2, density2
NCDF_CLOSE, fid

filename ='/home/liufei/Data/Parameters/MEIC_Emission/0.4/'+Yr4+'/'+Yr4+'__power__NOx.nc'
fid=NCDF_OPEN(filename)
varid3=NCDF_VARID(fid,'z')
NCDF_VARGET, fid, varid3, density3
NCDF_CLOSE, fid

filename ='/home/liufei/Data/Parameters/MEIC_Emission/0.4/'+Yr4+'/'+Yr4+'__transportation__NOx.nc'
fid=NCDF_OPEN(filename)
...
header_output2 = [['ncols 200'],['nrows 125'],['xllcorner 70'],['yllcorner 10'],['cellsize 0.4'],['nodata_value -999.0']]
outfile ='/home/liufei/Data/High_resolution/'+Yr4+'_emis_total.asc'
openw,lun,outfile,/get_lun
...
header = strarr(6,1)
filename = '/home/liufei/Data/Parameters/Population/0.4/urbanpop_04.asc'
