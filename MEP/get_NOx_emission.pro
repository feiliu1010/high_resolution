...
;infile = '/z1/gengguannan/forMEP/base/ctm.'+Yr4+Mon2+'01.bpch'
;outfile = '/home/gengguannan/work/MEP/factor/emis.'+Yr4+Mon2+'.save'
infile = '/z1/gengguannan/forMEP/base15/ctm.'+Yr4+Mon2+'01.bpch'
outfile = '/home/gengguannan/work/MEP/factor/emis.'+Yr4+Mon2+'.up15pctanth.save'
...
emis_total_up15pct = FltArr( InGrid.IMX, InGrid.JMX )
...
emis_total_up15pct[I+375,J+158] = data98[I,J]*area[I+375,J+158]*A ;unit=Gg NOx
...
print,total(emis_total_up15pct)

;save,emis_total,anth_ratio,filename=outfile
save,emis_total_up15pct,filename=outfile
