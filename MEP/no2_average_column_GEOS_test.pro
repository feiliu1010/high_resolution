pro no2_average_column_GEOS_test
...
for I = 0,InGrid.IMX-1 do begin
  for J = 0,InGrid.JMX-1 do begin
    if (nod1[I,J] gt 0L) then begin
       no2_omi_2012[I,J] /= nod1[I,J]
       no2_gc_2012[I,J] /= nod1[I,J]
    endif
    if (nod2[I,J] gt 0L) then begin
       no2_omi_2013[I,J] /= nod2[I,J]
       no2_gc_2013[I,J] /= nod2[I,J]
    endif
  endfor
endfor
...
NCDF_VarPut, FileID, nodID, nod1,    Count=[ InGrid.IMX, InGrid.JMX ]
...
NCDF_VarPut, FileID, nodID, nod2,    Count=[ InGrid.IMX, InGrid.JMX ]
