...
for year = year_start,year_end do begin
	...
	sample_domain_annual = fltarr(I2-I1+1L,J2-J1+1L)
	for month = month_start,month_end do begin
		Mon2 = string(month,format='(i2.2)')
		no2_domain_monthly = fltarr(I2-I1+1L,J2-J1+1L)
		sample_domain_monthly = fltarr(I2-I1+1L,J2-J1+1L)
		header=strarr(6,1)

		filename='/home/liufei/Data/High_resolution/0.01degree/NO2/sensitivity/'+sensitivity_file+'/no2_over_china_'+gsize_str+'deg_'+radius_smooth_str+'r_'+Yr4+Mon2+'_with_nasa_v2.asc'
		openr,lun,filename,/get_lun
		readf,lun,header,no2_domain_monthly
		close,lun
		Free_LUN,lun

		filename='/home/liufei/Data/High_resolution/0.01degree/NO2/sensitivity/'+sensitivity_file+'/no2_over_china_'+gsize_str+'deg_'+radius_smooth_str+'r_'+Yr4+Mon2+'_with_nasa_v2_num.asc'
                openr,lun,filename,/get_lun
                readf,lun,header,sample_domain_monthly
                close,lun
                Free_LUN,lun
		...
		sample_domain_annual[where(sample_domain_monthly gt 0.)]+=sample_domain_monthly[where(sample_domain_monthly gt 0.)]
	endfor;month
...
outfile ='/home/liufei/Data/High_resolution/0.01degree/NO2/sensitivity/'+sensitivity_file+'_no2_over_china_12km_with_nasa_v2.asc'
...
header_output = [['ncols 8000'],['nrows 4000'],['xllcorner 70'],['yllcorner 15'],['cellsize 0.01'],['nodata_value -999.0']]
outfile ='/home/liufei/Data/High_resolution/0.01degree/NO2/sensitivity/'+sensitivity_file+'_no2_over_china_12km_with_nasa_v2_num.asc'
openw,lun,outfile,/get_lun
printf,lun,header_output,sample_domain_annual
close,lun
free_lun,lun
endfor;year
