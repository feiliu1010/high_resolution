...
;dir_omi='/z5/wangsiwen/07/'
dir_omi='/z5/wangsiwen/'
spawn,'ls '+dir_omi+'OMI-Aura_L2-OMNO2_'+Yr4+'m'+Mon2+'06*.asc ',list_omi
...
for nn = 0L,n_elements(ind_ok)-1L do begin
    ...
    y1_index = where(ymid ge glat(nn)-0.1 and ymid le glat(nn)+0.1)
...
;outfile = '/home/liufei/Data/High_resolution/0.01degree/NO2/save/no2_over_china_'+gsize_str+'deg_'+radius_smooth_str+'r_'+Yr_start+'_with_nasa_v2.save'
;endif else begin
;outfile = '/home/liufei/Data/High_resolution/0.01degree/NO2/save/no2_over_china_'+gsize_str+'deg_'+radius_smooth_str+'r_'+Yr_start+'-'+Yr_end+'_with_nasa_v2.save'
;endelse
...
outfile ='/home/liufei/Data/High_resolution/0.01degree/NO2/no2_over_china_'+gsize_str+'deg_'+radius_smooth_str+'r_'+Yr_start+'_with_nasa_v2_06.asc'
openw,lun,outfile,/get_lun
printf,lun,header_output,no2_domain_annual
close,lun
free_lun,lun

;outfile ='/home/liufei/Data/High_resolution/0.01degree/NO2/no2_over_china_'+gsize_str+'deg_'+radius_smooth_str+'r_'+Yr_start+'_with_nasa_v2_num_02.asc'
;openw,lun,outfile,/get_lun
